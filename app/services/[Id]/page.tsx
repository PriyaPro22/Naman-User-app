...
import { ArrowLeft, Star, Verified, CheckCircle, Shield, Tag, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-bg pb-24">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-3 shadow-hard">
        <div className="flex justify-around items-center">
          ...
          <Link href="/cart" className="flex flex-col items-center text-yellow-primary">
            <ShoppingCart size={24} />
            <span className="text-xs mt-1 font-semibold">Cart</span>
          </Link>
          
          <Link href="/profile" className="flex flex-col items-center text-text-gray hover:text-yellow-primary">
            <User size={24} />
